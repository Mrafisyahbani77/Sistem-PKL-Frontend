...
const FormTambah = ({ onClose, onSubmit, formData, onInputChange }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(error.message || 'Gagal menambahkan akun. Pastikan data yang dimasukkan valid.');

      // Tampilkan notifikasi SweetAlert2 gagal
      Swal.fire({
        icon: 'error',
        title: 'Gagal',
        text: error.message || 'Gagal menambahkan akun. Pastikan data yang dimasukkan valid.',
      });
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <div>
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div className="mt-4">
          <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded-md" disabled={submitting}>
